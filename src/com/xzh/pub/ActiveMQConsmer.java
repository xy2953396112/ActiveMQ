...
public class ActiveMQConsmer {
    ...
    public static void main(String[] args) throws JMSException {
		...
		// ÊµÀý»¯Á¬½Ó¹¤³§
		connectionFactory=new ActiveMQConnectionFactory(ActiveMQConsmer.USERNAME,ActiveMQConsmer.PASSWORD,ActiveMQConsmer.BROKEURL); 
